...
namespace ServiceCochesClass
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceCochesClass.ICochesContract")]
    public interface ICochesContract
    {
        ...
        System.Threading.Tasks.Task<ServiceCochesClass.Coche[]> GetCochesAsync();
        ...
        System.Threading.Tasks.Task<ServiceCochesClass.Coche> FindCocheAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface ICochesContractChannel : ServiceCochesClass.ICochesContract, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class CochesContractClient : System.ServiceModel.ClientBase<ServiceCochesClass.ICochesContract>, ServiceCochesClass.ICochesContract
    {
        ...
        public System.Threading.Tasks.Task<ServiceCochesClass.Coche[]> GetCochesAsync()
        {
            return base.Channel.GetCochesAsync();
        }
        
        public System.Threading.Tasks.Task<ServiceCochesClass.Coche> FindCocheAsync(int id)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICochesContract))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:21963/ServiceCoches.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
